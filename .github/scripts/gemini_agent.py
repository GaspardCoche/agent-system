...
TASK_PROMPTS = {
    ...
    "ai_digest": (
        ...
        "- IMPORTANT: Look for the 'Article Images' section at the end — it maps article URLs to their real og:image photos\n"
        "- For image_url: ALWAYS prefer the real article image from that section over logos/favicons\n"
        "- If no article image found, use the source Logo URL as fallback\n"
